...
> 2026-08-24 注记：本文档为 Phase 1D 冻结记录，正文保持原样；后续 family 扩展（评测四 family、research memory 四 family、P7A candidate/closure/context 三 family）见 ADR-0006/0007/0010 与 `schemas/core/README.md`。
