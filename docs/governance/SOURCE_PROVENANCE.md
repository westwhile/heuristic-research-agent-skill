...
three Phase 6 L3 runner/selection files,
...
The proposed Phase 6 L3 selection tree contains 864 files:

| Source class | Count | Boundary |
|---|---:|---|
| `independently_authored` | 731 | Repository-native material covered by the maintainer confirmation |
