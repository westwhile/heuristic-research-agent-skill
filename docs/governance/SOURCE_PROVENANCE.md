...
files, thirteen Phase 6 L1 manifest files, and two Phase 6 L2 runner files,
...
The proposed Phase 6 L2 runner tree contains 861 files:

| Source class | Count | Boundary |
|---|---:|---|
| `independently_authored` | 728 | Repository-native material covered by the maintainer confirmation |
