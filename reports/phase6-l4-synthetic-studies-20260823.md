...
状态：**本地工作树合成工程证据**。本报告只证明 L4 case、study-report 与
...
与 `framework=not_loaded`。PR #21 的提交 `322159b8...` 已有四平台/解释器 CI
证据，但只覆盖 L1–L3；当前 L4 仍需 commit-bound `git archive` 双解释器 Gate
和该提交的四项 CI 后，才能形成 L4 平台证据。跨 GPU 数值复现性全部未验证。
