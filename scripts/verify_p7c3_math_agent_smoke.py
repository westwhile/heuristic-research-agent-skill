...
def _safe_trial_summary(outcome: Any) -> dict[str, Any]:
    ...
    for arm in ("baseline", "candidate"):
        ...
        arms[arm] = {
            ...
            "runtime_loaded_matches": environment["runtime_loaded_matches"],
            "runtime_name_matches": environment["runtime_name_matches"],
            "runtime_digest_matches": environment["runtime_digest_matches"],
